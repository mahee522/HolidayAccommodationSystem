<!-- Author: Daryl Roche C00184621 
	 ...
	 Purpose of Page: Main File For Amending a Client-->
<?php session_start();
...
<head lang="en">
    ...
    <link href="../../css/AmendClient.css" rel="stylesheet" type="text/css">
	...
	<script src="AmendClient.js"></script>
                ...
                <ul id="menu">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <a href="AmendClient.php"><li>Amend/View Client</li></a>
        ...
        <div id="mainSection">
            <div id="header">
                ...
                <div id="LocationTimeSection">
                    <div id="location">Amend / View Client</div>
                    <div id="time"></div>
                </div>
            </div>
            <div id="content">
                 <form name="amendForm" id="amendForm" action="ClientAmend.php">
                    <div id="inputs">
						<div id="SelectClient">
                        ...
                        <div id="leftSide">
                            ...
                            <input type="text" name="name" id="name" patten="[A-Z][a-z]" disabled>
                            <br><br>
                            <label>Last Name:</label>
                            <input type="text" name="lastName" id="lastName" patten="[A-Z][a-z]" disabled>
                            <br><br>
                            <label>Address Line 1:</label>
                            <input type="text" name="address1" id="address1" patten="[1-9]+ [A-Z][a-z]" disabled>
                            <br><br>
                            <label>Address Line 2:</label>
                            <input type="text" name="address2" id="address2" patten="[A-Z][a-z]" disabled>
                            <br><br>
                            <label>Address Line 3:</label>
                            <input type="text" name="address3" id="address3" patten="[A-Z][a-z]" disabled>
                            <br><br>
							
                        </div>
                        <div id="rightSide">
							<label>County:</label>
							<input type="text" name="County" id="County" patten="[A-Z][a-z]" disabled>
							<br><br>
							<label>Country:</label>
                            <input type="text" name="Country" id="Country" patten="[A-Z][a-z]" disabled>
                            <br><br>
                            <label>Phone Number:</label>
                            <input type="text" name="phone" id="phone" pattern="[0-9]{2,3}+-[0-9]{2}+-[0-9]{5,}" disabled>
                            <br><br>
                            <label>Mobile:</label>
                            <input type="text" name="Mobile" id="Mobile" pattern="0+[1-9]{2}+-[0-9]{5,}" disabled>
                            <br><br>
                            <label>Email:</label>
							<input type="email" name="Email" id="Email" pattern="[a-z0-9]+@[a-z0-9]+.[a-z]{2,3}" disabled>
                            <input type="number" style="display:none" name="GetID"  id="GetID"/>
                        </div>
                        <br><br><br>
                    </div>
					<div id="Amend">
					<button type="button" class="Amend" onclick="change()">Edit</button>
					</div>
                    <div id="buttons">
                        <button type="reset" class="clear" onclick="startTime()">Cancel</button>
						<button type="button" class="submit" onclick="checkAmend()">Amend</button>
                    </div>
                </form>
            </div>
