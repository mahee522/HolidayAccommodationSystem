<!--
  ...
  Course: Software Development
  	...
  	Purpose: Main page that appears for cancel booking
			 displays a table of clients that have a booking.
			 By choosing a client and clicking "cancel booking"
			 booking is deleting.
...
<head lang="en">
    ...
    <link href="../css/CancelBooking.css" rel="stylesheet" type="text/css">
        ...
        <div id="mainSection">
            <div id="header">
                ...
                <div id="LocationTimeSection">
                    <div id="location">Cancel Booking</div>
                    <div id="time"></div>
                </div>
            </div>
            <div id="content">
                ...
                <?php include "viewBookings.php";?>
                    ...
                    <div id="button">
                        <button type="submit" class="submit" onclick="return bookingDeletionFoo()">Cancel Booking</button>
...
<script> // this script is used by JList plugin for JQuery -> purpose is to search information in table
        // initializing option objects with the names of table row
    var options = {
        valueNames: [ 'arrival', 'fullname', 'address', 'county', 'country', 'phone', 'duration', 'acctype', 'accdesc' ]
    };
