<!--
  ...
  Course: Software Development
    ...
    Purpose: The main page that appears when in departure screen.
...
<head lang="en">
    ...
    <link href="../css/ClientDeparture.css" rel="stylesheet" type="text/css">
...
<body onload="amountOwedRedirect()"> <!-- checks whether session variable that responsible for amount owed is set or no-->
<div id="wrapper">
    <div id="site">
        <div id="menuSection">
            <div id="logoSection">
        ...
        <div id="mainSection">
            <div id="header">
                ...
                <div id="LocationTimeSection">
                    <div id="location">Client Departure</div>
                    <div id="time"></div>
                </div>
            </div>
            <div id="content">
                <form action="updateDeparture.php" method="post">
                    <div id="inputs">
                        <div id="listBoxSection">
                            <label>Departures</label><br>
                            <?php include "departureQuery.php";?>
                            <br><br>
                    ...
                    <div id="buttons">
                        ...
                        <button type="submit" class="submit" onclick="return conformationBookingStatus()">Confirm Departure</button>
                    </div>
                </form>
