<!--
  ...
  Course: Software Development
	...
	Purpose: Main page for rental report that display a table
			 of all rentals that have departed.
 -->
...
<head lang="en">
    ...
    <link href="../css/RentalReport.css" rel="stylesheet" type="text/css">
                ...
                <ul id="menu">
                    ...
                    <li><img class="icons" src="../Icons/reports.png"> Reports
                        <ul>
                            ...
                            <a href="../Jason/AccommodationsReadyToday.php.php"><li>Accommodation To Be Ready Today Report</li></a>
        ...
        <div id="mainSection">
            <div id="header">
                ...
                <div id="LocationTimeSection">
                    <div id="location">Rental Report</div>
                    <div id="time"></div>
                </div>
            </div>
            <div id="content">
                ...
                <?php include "viewRentalReport.php";?>
            </div>
            </form>
        </div>
...
<script> // this script is used by JList plugin for JQuery -> purpose is to search information in table
    ...
    var options = {
        valueNames: [ 'date', 'name', 'type', 'duration', 'cost']
    };
