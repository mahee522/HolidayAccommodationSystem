<!--
	Name: AmendAccommodation.php
	Purpose: Form used to amend and Accommodation in the database
...
<head lang="en">
    ...
    <link href="../css/AmendAccommodation.css" rel="stylesheet" type="text/css">
	...
	<script src="../js/IvanFile.js"></script>	<!--File used to deal with empty page links -->
    <title></title>
</head>
<body>
<div id="wrapper">
        ...
        <div id="mainSection">
            <div id="header">
                ...
                <div id="LocationTimeSection">
                    <div id="location">Amend Accommodation</div>	<!--Page heading-->
                    <div id="time"></div>	<!--Section used to hold clock-->
                </div>
            </div>
            <div id="content">
                 <form action="amendViewAccommodation.php" onsubmit="return confirmCheck()" method="Post">
                    <div id="inputs">
                        <br><br><br>
						<div id="type">
							...
							<label>ID:</label>
							<input type="text" name="accId" id="accId" value="" disabled />	<!--Adds a disabled field displaying matching Accommodation ID-->
							<br><br>
							<input type="button" value="Amend Details" id="amendButton" onclick="toggleLock()"><br> <!--When clicked, ask confirmation-->
						</div>
						<div id="fields">
...
<script>
		function confirmCheck()
		{
			...
			if(response)	//Fields need to be unlocked to input values to database
			{
				...
				document.getElementById("rentalCat").disabled = false;
				document.getElementById("accLocation").disabled = false;
